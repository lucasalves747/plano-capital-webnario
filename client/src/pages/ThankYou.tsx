    ...
    >
      ...
      <section style={{ padding: "4rem 1.5rem", maxWidth: "680px", margin: "0 auto" }}>
        <div
          ...
          style={{ borderLeft: "2px solid #C9A84C", paddingLeft: "2rem", marginBottom: "3rem" }}
        >
        ...
        <div className="animate-fade-in-up animate-delay-300" style={{ textAlign: "center" }}>
          <a
            ...
            className="btn-cta"
            style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.75rem", fontSize: "0.9rem", padding: "1.1rem 2rem" }}
          >
